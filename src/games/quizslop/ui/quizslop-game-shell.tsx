...
import { useQuizslopSounds } from "./use-quizslop-sounds";
    ...
    <MotionConfig reducedMotion="user">
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <span
              className="rounded-full px-3 py-1 font-mono text-sm font-bold uppercase tracking-widest"
        ...
        {inRound ? (
          <div className="z-10 px-4 pt-4 sm:px-8 sm:pt-6">
            <QuizslopFlowProgress
              phase={phase}
