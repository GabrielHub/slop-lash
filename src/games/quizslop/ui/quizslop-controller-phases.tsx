          ...
          return (
            <li key={offer.catalogTopicId}>
              ...
              >
                ...
                />
                <span
                  className="mt-1 block text-center font-mono text-[10px] font-bold uppercase tracking-wider"
          ...
          <WaitingCard
            text={
              lobby.everyoneReady
                ...
                : "Waiting for the others to lock their topics."
            }
          />
        </motion.div>
      )}
          ...
          return (
            <li key={entry.topicId}>
              ...
              >
                ...
                {isMine && (
                  <span
                    className="mt-1 flex items-center justify-center gap-1 font-mono text-[10px] font-bold uppercase tracking-wider"
                    style={{ color: "var(--qs-signal)" }}
                  >
  ...
  return (
    <section className="flex flex-col gap-4">
      <SectionTitle
        ...
        hint={
          canSpend
            ? "Spend one token to predict a miss, or hold."
...
export function ControllerReveal({
  ...
  const myGroupFirst = [...visible].sort((a, b) => {
    const aMine =
