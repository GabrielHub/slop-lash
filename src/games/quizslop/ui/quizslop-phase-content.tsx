...
export function QuizslopStagePhaseContent({
  ...
  switch (view.phase) {
    ...
    case "DISPUTE_WINDOW":
      return <StageDisputeWindow revealGroups={view.revealGroups} ballots={view.ballots} />;
    case "DISPUTE_VOTE":
      return <StageDisputeVote ballots={view.ballots} />;
    case "ROUND_RESULTS":
  ...
  switch (view.phase) {
      ...
      return view.lobby ? (
        <div className="flex flex-col gap-4">
          <ControllerLobby
            lobby={view.lobby}
            busyTopicId={
              busyAction?.startsWith("topic:") ? busyAction.slice("topic:".length) : null
            }
          ...
          {view.me.isHost && (
            ...
            >
              {busyAction === "host:start" ? "Starting..." : "Start the show"}
            </button>
          )}
        </div>
      ) : (
    ...
    case "HOUSE_VOTE":
      return view.houseVote ? (
        <ControllerHouseVote
          ...
          busyTopicId={busyAction?.startsWith("vote:") ? busyAction.slice("vote:".length) : null}
    ...
    case "DISPUTE_WINDOW":
      return view.dispute ? (
        ...
        <ControllerPassiveWait
          title="Disputes"
          text="The dispute window is open on player phones."
        />
      );
    case "DISPUTE_VOTE":
      return (
        <ControllerDisputeVote
          ...
          busyDisputeId={
            busyAction?.startsWith("ballot:") ? busyAction.slice("ballot:".length) : null
          }
