...
export const QUIZSLOP_VOICE_LINES: readonly QuizslopVoiceLine[] = [
  ...
  },
  {
    ...
    tag: "DISPUTE_WINDOW",
    text: "Think the quizmaster slipped? Now is the moment to say so.",
    accessibleLabel: "Challenge a question now, or continue.",
    review: APPROVED_REVIEW,
  },
  {
    id: "vl-dispute-window-4",
    tag: "DISPUTE_WINDOW",
    text: "Spotted a shaky answer key? Flag it before the window shuts.",
    accessibleLabel: "You may challenge one question.",
    review: APPROVED_REVIEW,
  },
  {
    id: "vl-dispute-window-5",
    tag: "DISPUTE_WINDOW",
    text: "One question looking suspect? Put it on trial.",
    accessibleLabel: "Dispute a question if needed.",
    review: APPROVED_REVIEW,
  },
  // DISPUTE_VOTE
  {
  ...
  },
  {
    ...
    tag: "FINAL_RESULTS",
    text: "Game over. One champion, and a room full of rematch demands.",
    accessibleLabel: "The game has ended; the winner is shown.",
    review: APPROVED_REVIEW,
  },
];
