...
export const AI_MODELS: AIModel[] = [
  ...
  { id: "xai/grok-4.20-reasoning-beta", name: "Grok 4.20 Beta", shortName: "Grok", provider: "xAI", icon: "/icons/grok-light.svg", iconDark: "/icons/grok-dark.svg", inputPer1M: 2.00, outputPer1M: 6.00 },
