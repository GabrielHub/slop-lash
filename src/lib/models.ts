...
export const AI_MODELS: AIModel[] = [
  ...
  { id: "zai/glm-5.1", name: "GLM-5.1", shortName: "GLM", provider: "Zhipu AI", icon: "/icons/zai-light.svg", iconDark: "/icons/zai-dark.svg", inputPer1M: 1.40, outputPer1M: 4.40 },
  { id: "minimax/minimax-m2.7", name: "MiniMax M2.7", shortName: "MiniMax", provider: "MiniMax", icon: "/icons/minimax-color.svg", inputPer1M: 0.30, outputPer1M: 1.20 },
  ...
  { id: "openai/gpt-5.4-mini", name: "GPT-5.4 Mini", shortName: "GPT", provider: "OpenAI", icon: "/icons/openai-light.svg", iconDark: "/icons/openai-dark.svg", inputPer1M: 0.75, outputPer1M: 4.50 },
  ...
  { id: "xai/grok-4.20-non-reasoning", name: "Grok 4.20", shortName: "Grok", provider: "xAI", icon: "/icons/grok-light.svg", iconDark: "/icons/grok-dark.svg", inputPer1M: 2.00, outputPer1M: 6.00 },
  ...
  { id: "anthropic/claude-haiku-4.5", name: "Claude Haiku 4.5", shortName: "Claude", provider: "Anthropic", icon: "/icons/claude-color.svg", inputPer1M: 1.00, outputPer1M: 5.00 },
];
