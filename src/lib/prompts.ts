const PROMPT_BANK: string[] = [
  ...
  "The most dangerous aisle at Costco",
  ...
  "The fastest way to deplane",
  "The worst thing for you to lose your grip on",
  "The wrong way to hold a beanie baby",
  "The worst time to be using noise-cancelling headphones",
  "The worst way to mow your neighbor's lawn",
  "The most embarrassing thing to shoulder press at the gym",
  "The best mode of transportation to outrun a tsunami",
  "The worst place to buy your Canada Goose",
  "The last thing your father said to you before he died",
  "I would replace wheelchair-accessible ramps with ______",
  "The last place you'd expect to find Cambodian land mines",
  ...
  "A terrible thing to name a boat",
  ...
  "Name a restaurant from the mind of the Papa John's guy",
  ...
  "What a queen ant does on her smoke break",
  "What you'd actually find 20,000 leagues under the sea",
  "What's on a vampire's menu when it's on a keto cleanse",
  "What your dog was thinking when you took him to the vet for 'a quick visit'",
  "The real secret ingredient Colonel Sanders has been hiding",
  "The last place you found your mother's bath salts",
  ...
  "Everyone is mad that Google is sunsetting ______",
  "The thing you accidentally copy-pasted into the work Slack",
  "______ absolutely needs a dark mode",
  "Instagram just started pushing ______ to the top of everyone's feed",
  "What you're actually doing at 9:30 AM every workday",
  "Your favorite podcaster's favorite podcast",
  ...
  "What the Italians used as weapons in World War II",
  "How would you have stopped the bullet that killed JFK?",
  "What was Hercules's hardest trial",
  "What Tom and Jerry were doing in World War Two",
  "The one vehicle you wouldn't let Harrison Ford operate",
  "The name of Casper's sex tape",
  "Zendaya is starring in a live-action remake of ______",
  "What did Michael Jackson really see in the mirror?",
  "Chris Pratt was secretly ______ on the set of ______",
  "Did no one else find it strange that the Kung Fu Panda musical had ______",
  "What did you find between the two ferns?",
  "Batman may have the batcave, but Bruce Wayne has ______",
  "The Mario Brothers just ______ in New York",
  "What's on Fidel Castro's mixtape",
  "Your go-to strategy when playing battleship against Professor X",
  "The only thing Jeff Bezos doesn't have his hands in",
  "The sequel to Daniel Radcliffe's Guns Akimbo",
  "What's causing Jonah Hill's spring allergies?",
  "The last vestige of Jared Leto's movie career would be ______",
  "______ just solved Jackie Chan's relationship with his daughters",
  "How does Tiger Woods relax after a furious goon sesh",
  "What really killed Juice WRLD?",
  "John Woo's cure for seasonal depression ______",
  "The founding father with the most unhinged aura",
  "The Shakespeare line that goes the hardest in a rap battle",
  "A Bible verse that goes inexplicably hard",
  ...
  "Can't believe the chef just served ______ at a Michelin-star omakase",
  "The best excuse you've heard for cannibalism",
  ...
  "The first thing you step on after stepping off this mortal coil",
  "If crime were legal for a day, I'd ______",
  "Yo-yos were invented to ______",
  "______ invented the ______ in 1984",
  "The monument you'd build to your own ego",
  ...
  "Your favorite topic to mansplain",
  "What are you the LeBron James of?",
  "Your go-to phrase to get out of middling pillow talk",
  "The one machine you're comfortable operating under the influence",
  "The insane reason your partner left you",
  "The primary ingredient in your homemade baldness remedy",
  "The real reason your partner hates jazz",
  ...
  "How do you sleep at night knowing that ______",
  "Autocorrect keeps changing ______ to ______",
  "The person next to you wrote a really uncomfortable manifesto on ______",
  "The person next to you is secretly writing ______ fan fiction",
  "I can't come into work today, I have chronic ______",
  "______ got me banned from the high school talent show",
  "I keep finding ______ in my local recycling bins",
  "Ran out of toilet paper recently, had to use ______ instead",
  "You just spent your kid's college savings on ______ and now they have to become VTubers",
  "I don't understand why no one ______ at Panda Express",
  "Whatever you do, do not bleach the ______",
  "The quickest way to get an American green card",
  "The second best thing to a white picket fence",
  "They're replacing the school blackboards with ______",
  "The PTA had to get involved because of your child's ______",
  "The finishing touch to your perfect sand castle",
  "What else can't you lead a horse to?",
  "The last thing you'd expect to get a Vegas residency",
  "The one thing we need to tariff right now",
  "The best thing to add proximity chat to",
  "______ has really helped me stop masturbating, you should try it",
  "______ was the key to unlocking Jack Daniel's chastity belt",
  "The Epstein files just revealed his third favorite hobby was ______",
  "Malcolm Gladwell's hot tips to ______",
  "The fastest way to evict a tapeworm from my lower intestine",
  "The last thing Optimus Prime says before he slimes your ass",
  "A pornstar name that would make even the industry blush",
  ...
  "I stubbed my toe on ______ and I've never been the same",
  "Gentlemen, I may not have a brain, but ______",
  "I just ______ in high heels — what's your excuse?",
  "We can't just ______ — think of the electric bill",
  ...
  "Scientists just discovered ______ has human traits",
  "DANGER! ______ has escaped containment",
  ...
  "Friday is for the boys, Saturday is for ______",
  "Sorry honey, the wheels on the bus are handling ______",
  "I don't know anyone who's finished watching The Summer I Turned ______",
  "Moooooom, Phineas and Ferb just built a ______",
  "To a ______ everything looks like a ______",
  ...
  "The worst thing to mistake for AI slop",
  "The main reason we should just be playing Quiplash instead",
  "Let's discuss 100 men vs 1 ______",
  "The next piece of furniture JD Vance has his eyes on",
  "I've heard enough, short kings ______",
  "The perfect ingredients for a girl dinner",
  "Is this thing on?",
  "The last 4 digits of your social security number",
  "Holy shit, Lil Nas X just solved ______",
  "______ can get it. Raw. No hesi.",
  "Chat, am I cooked? I just ______",
  "Only in Ohio would you see ______ at a ______",
  "The sigma grindset tip that is genuinely concerning",
  "The ick that would end a relationship in one second flat: ______",
  "______ understood the assignment. The assignment was ______.",
  "The person who invented ______ was either a genius or completely tweaking",
  "______ is NOT beating the ______ allegations",
  "______ has negative aura and everyone in the room can feel it",
  ...
  "The last thing your uncle says before he griefs your Minecraft world",
  "A deleted power-up from the newest Mario game",
  "A Pokemon move that's actually just a war crime",
  "The Pokemon that is definitely going through something right now",
