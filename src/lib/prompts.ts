const PROMPT_BANK: string[] = [
  ...
  "Board man gets paid, but board man also gets ______",
  ...
  "Jimmy Butler's Instagram story during the trade saga: ______",
  ...
  "The NBA Cup court design this year looks like ______",
  ...
  "The thing that would finally make Kawhi Leonard laugh: ______",
  ...
  "The secret fourth thing on Draymond Green's 'natural basketball plays' list: ______",
