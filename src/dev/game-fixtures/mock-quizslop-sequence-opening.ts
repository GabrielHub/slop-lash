...
export function appendQuizslopOpeningSequence(script: QuizslopFixtureScript): void {
  ...
  pushBeat({
    ...
    title: "R1 · 1 of 4: Topic reveal",
    description:
      "Host-paced first-round briefing: see the topic, optionally Call Slop, answer privately, then watch every answer reveal together.",
    phase: "TOPIC_REVEAL",
    deadlineSeconds: null,
    currentRound: 1,
    roundKind: "WARM_UP",
  ...
  pushBeat({
    slug: "r1-call-reveal",
    title: "R1 · 2 of 4: Calls revealed",
  ...
  pushBeat({
    slug: "r1-answer",
    title: "R1 · 3 of 4: Private answer",
    description:
  ...
  pushBeat({
    ...
    title: "R1 · 4 of 4: Shared reveal · Question 1 of 1",
    description:
      "The opening reveal waits for the host, so the room can read it and learn how scoring lands.",
