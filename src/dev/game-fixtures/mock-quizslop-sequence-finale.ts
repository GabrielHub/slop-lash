...
export function appendQuizslopFinaleSequence(script: QuizslopFixtureScript): void {
  ...
  pushBeat({
    slug: "r5-reveal-group-1",
    title: "R5: shared reveal · Question 1 of 4",
    description: "Priya's question owns the screen and a full 30-second reading turn.",
  ...
  pushBeat({
    slug: "r5-reveal-group-2",
    title: "R5: shared reveal · Question 2 of 4",
    description:
      "Marcus's question becomes the dominant receipt; the first remains secondary history.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 5,
    roundKind: "HOME_TURF",
    ...
    currentTopic: r5Topic,
    topicOwnerName: playerName("P2"),
    revealDefs: [r5Groups[0]!, r5Groups[1]!],
    revealOrdinal: 1,
    revealTotal: 4,
    controllers: noControllers,
  });
  ...
  pushBeat({
    slug: "r5-reveal-group-3",
    title: "R5: shared reveal · Question 3 of 4",
    description:
      "Jo's result gets its own 30-second turn instead of sharing a timer with other explanations.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 5,
    roundKind: "HOME_TURF",
    ...
    currentTopic: r5Topic,
    topicOwnerName: playerName("P2"),
    revealDefs: [r5Groups[0]!, r5Groups[1]!, r5Groups[2]!],
    revealOrdinal: 2,
    revealTotal: 4,
    controllers: noControllers,
  });
  ...
  pushBeat({
    slug: "r5-reveal-group-4",
    title: "R5: shared reveal · Question 4 of 4",
    description:
      "Tal's question closes the reveal sequence; reveal order remains unrelated to hidden tier.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 5,
    roundKind: "HOME_TURF",
  ...
  pushBeat({
    ...
    title: "R6: vote reveal — tie-breaker decides it",
    description:
  ...
  pushBeat({
    slug: "r6-reveal-group-1",
    title: "R6: finale reveal · Question 1 of 4",
    description: "The first double-point question gets a full 30-second reveal turn.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 6,
    roundKind: "HOUSE_CHOICE",
  ...
  pushBeat({
    slug: "r6-reveal-group-2",
    title: "R6: finale reveal · Question 2 of 4",
    description:
      "Question two becomes the shared focus while question one remains secondary history.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 6,
    roundKind: "HOUSE_CHOICE",
    ...
    participantsFrozen: true,
    currentTopic: finaleTopic,
    revealDefs: [r6Groups[0]!, r6Groups[1]!],
    revealOrdinal: 1,
    revealTotal: 4,
    controllers: noControllers,
  });
  ...
  pushBeat({
    slug: "r6-reveal-group-3",
    title: "R6: finale reveal · Question 3 of 4",
    description: "Jo's result gets its own readable explanation and double-point delta.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 6,
    roundKind: "HOUSE_CHOICE",
    ...
    participantsFrozen: true,
    currentTopic: finaleTopic,
    revealDefs: [r6Groups[0]!, r6Groups[1]!, r6Groups[2]!],
    revealOrdinal: 2,
    revealTotal: 4,
    controllers: noControllers,
  });
  ...
  pushBeat({
    slug: "r6-reveal-group-4",
    title: "R6: finale reveal · Question 4 of 4",
    description: "The last question closes the finale only after its own 30-second reveal turn.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 6,
    roundKind: "HOUSE_CHOICE",
