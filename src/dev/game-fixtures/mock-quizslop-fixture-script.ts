...
export function publicTopic(catalogId: string): QuizslopViewPublicTopic {
...
export function slateEntry(catalogId: string): QuizslopViewSlateEntry {
  return { topicId: `slate-${catalogId}`, ...publicTopic(catalogId) };
}
...
interface BeatConfig {
  ...
  currentTopic?: QuizslopViewPublicTopic | null;
