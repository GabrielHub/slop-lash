...
export function appendQuizslopMiddleSequence(script: QuizslopFixtureScript): void {
  ...
  pushBeat({
    ...
    title: "R2: reveal group 1 of 2",
    description:
      "Hidden tiers diverged: Priya and Marcus shared one question while Jo saw another.",
  ...
  pushBeat({
    ...
    title: "R2: reveal group 2 of 2",
    description: "Paced receipts: the second distinct question becomes the hero card.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 2,
    roundKind: "HOME_TURF",
  ...
  pushBeat({
    slug: "r3-reveal-timeout",
    title: "R3: reveal — the timeout receipt",
    description:
      "Group 2 of 3 is the hero: Marcus timed out and is marked incorrect, icon and label, never color alone.",
    phase: "QUESTION_REVEAL",
    deadlineSeconds: QUESTION_REVEAL_SECONDS_PER_GROUP,
    currentRound: 3,
    roundKind: "HOME_TURF",
