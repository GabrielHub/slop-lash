...
A reference for writing Quiplash-style prompts that consistently produce funny answers. Synthesized from Jackbox Games developer commentary, Cards Against Humanity design patterns, and analysis of what top comedians in 2025-2026 are riffing on.
...
```
"The worst thing to [verb] [in/at/during context]"
"The best part about [bad situation]"
"The most [adjective] thing to [verb] [context]"
```
...
```
"Name a [product type] that [absurd qualifier]"
"Come up with a name for [absurd thing]"
"A rejected name for [known thing]"
"A terrible [brand/slogan/title] for a [noun]"
```
...
```
"I'm sorry officer, I had no idea it was illegal to ______"
"Instead of [normal thing], the world's worst [place] gives you ______"
"The real secret to [desirable outcome] is ______"
...
"TSA now requires all passengers to ______"
"Breaking news: Scientists confirmed that ______ is sentient"
"NASA's next mission: send ______ to Mars"
"The newest Geneva Convention rule: ______ is now a war crime"
```
...
"Got ______?"
"[Brand] : We Have ______"
"Just Do It — specifically, ______"
```
...
```
"A deleted scene from [children's movie]"
"A children's book titled ______"
"The most concerning line in a fairy tale: '______'"
"A terrible bedtime story for a five-year-old"
```
...
```
"What [animal/object] is actually thinking"
"What [thing] would put on its Yelp review"
"The real reason [mundane thing] happens"
"What your [device/pet/thing] judges you for"
```
...
```
"The best thing about [terrible situation]"
"A surprisingly good reason to [terrible thing]"
...
```
"Using only two words, [do something]"
"A four-word sentence that would [consequence]"
"In exactly three words, describe [thing]"
```
...
"Scientists just confirmed: ______ is actually good for you"
...
```
"If [animals/objects/etc.] could [human thing], the first thing they'd do is ______"
"If your last meal had to be from [place], you're ordering ______"
"What would happen if [absurd premise]"
```
...
## Comedy Topics That Resonate (2025-2026)
...
- **Dating app culture** — swipe fatigue, profile cliches, ghosting etiquette, AI-written openers
...
- **Therapy-speak everywhere** — "boundaries," "toxic traits," "that's not a boundary, that's just rude"
- **Remote work permanence** — Zoom fatigue, working from bed, pants-optional lifestyle
- **Brain-rot humor** — unexplainable viral trends, brainrot characters, things that "go hard for no reason"
- **Celebrity scandal shorthand** — Diddy parties, hot criminals, leaked DMs
- **Crowd work comedy** — the "what do you do for a living?" as universal comedy opener
...
- **Theo Von**: Absurd Southern metaphors — "adulthood is like eating soup with a fork"
- **Leanne Morgan**: Physical comedy stories — ski disasters, trying CBD for the first time
- **Taylor Tomlinson**: Religious deconstruction — faith trauma, confronting death
- **Matt Rife / Andrew Schulz**: Crowd work energy — rapid-fire improvisation, "what do you do?"

---

## Cards Against Humanity Lessons

CAH's design offers key insights for Quiplash-style prompts:
...
4. **Cultural references create instant recognition.** Brand slogans, movie titles, famous quotes — everyone knows the original, so subversion gets a head start on funny.

5. **Dual blanks multiply possibilities.** Two variables create emergent humor from the relationship between answers. Use these sparingly for variety.

---

## Anti-Patterns (What to Avoid)

- **Too vague**: "Something funny" — infinite answers, none of them good
- **Too specific**: "A funny thing a one-armed clown would say to a nun at a rodeo in 1987" — only one answer works
- **Too restrictive**: Prompts requiring deep niche knowledge (obscure historical figures, technical jargon)
- **Restating the prompt**: "The worst joke" — the answer is just... a bad joke. No reframing.
- **Multiple qualifiers**: One unexpected detail is the sweet spot. Two is cluttered. Three is a maze.
- **Inside jokes**: Unless the audience is specifically your friend group, avoid references only 10% of players will get
- **Pure shock value**: Edgy is good; gratuitous is lazy. The best dark humor has structure and surprise.
- **Redundancy**: Check if a structurally similar prompt already exists before adding a new one
...
1. **Draft the prompt** using one of the structural patterns above
2. **Run the 10-answer test** — can you brainstorm 10+ funny answers in 5 seconds?
